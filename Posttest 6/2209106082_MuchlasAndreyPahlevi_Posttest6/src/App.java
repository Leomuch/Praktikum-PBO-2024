...
public class App extends menu {
    public static void main(String[] args) throws IOException, ParseException {
        ...
        ArrayList<interfacePemain> pemainInterface = new ArrayList<>();
        ...
        while (true) {
            ...
            switch (pilihan) {
                case 1:
                    menuLihatDetail(pemainInterface, player, statistikPlayer, contract);
                    break;
                case 2:
                    menuTambahDetail(pemainInterface, player, statistikPlayer, contract);
                    break;
                case 3:
                    updatePemain(pemainInterface, player);
                    break;
                case 4:
                    hapusPemain(pemainInterface, player);
                    break;
                case 5:
                    exit str = new exit();
                    str.exitProgram();
    ...
    private static void menuTambahDetail(ArrayList<interfacePemain> pemainInterface, ArrayList<pemain> player, ArrayList<statistik> stat, ArrayList<kontrakPemain> contract) throws IOException, ParseException {
        InputStreamReader isr = new InputStreamReader(System.in);
        BufferedReader br = new BufferedReader(isr);
        menu obj = new menu();
        int pilihan;
            ...
            switch (pilihan) {
                ...
                case 4:
                    if (player.isEmpty()) {
                        ...
                        perpanjanganKontrak(pemainInterface, player, contract);
                    }
                    break;
                case 5:
                    if (player.isEmpty()) {
    ...
    private static void menuLihatDetail(ArrayList<interfacePemain> pemainInterface, ArrayList<pemain> player, ArrayList<statistik> stat, ArrayList<kontrakPemain> contract) throws IOException, ParseException {
        InputStreamReader isr = new InputStreamReader(System.in);
        BufferedReader br = new BufferedReader(isr);
        menu obj = new menu();
        int pilihan;
    ...
    private static void tampilkanPemain(ArrayList<pemain> player, ArrayList<interfacePemain> interfacePemain) throws IOException {
        if (player.isEmpty()) {
            System.out.println("Belum Ada Data Pemain");
            pause();
        } else {
            ...
            for (int i = 0; i < player.size(); i++) {
                interfacePemain intfrc = interfacePemain.get(i);
                pemain plyr = player.get(i);
                String namaPemain = intfrc.namaPanggung("");
    ...
    private static void updatePemain(ArrayList<interfacePemain> pemainInterface, ArrayList<pemain> player) throws IOException {
        InputStreamReader isr = new InputStreamReader(System.in);
        BufferedReader br = new BufferedReader(isr);
    ...
    private static void hapusPemain(ArrayList<interfacePemain> pemainInterface, ArrayList<pemain> player) throws IOException {
        InputStreamReader isr = new InputStreamReader(System.in);
        BufferedReader br = new BufferedReader(isr);
